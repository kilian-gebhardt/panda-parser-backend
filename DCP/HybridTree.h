...
namespace DCP {
    ...
    private:
        ...
        void
        terminals_recur(std::vector<std::pair<Position, Terminal>> &terminals, const std::vector<Position> &positions) {
    ...
    template<typename Terminal, typename Position>
    void HybridTree<Terminal, Position>::add_node(
            Position position1
            , Terminal tree_label
            , Terminal string_label
            , Position position2
    ) {
